...
console.log(str.includes("TYPESCRIPTS")); //false
...
console.log("ends with abc : ", str.endsWith("abc"));

//7. replace()
//"Hello, TypeScript!"

console.log("Repleased String : ", str.replace("Typescript", "Hello"));

//8. split() - break the string into multiple parts based on the delimeter, returns an array

//Ex1:
let word: string[] = str.split(" ");
console.log("After splitting string:", word); //[ 'Hello,', 'TypeScript!' ]
//Ex2:
let mystring: string = "abc@gmail.com,xyzabc";
let arr: string[] = mystring.split(",");
console.log("After splitting string:", arr); //[ 'Hello,', 'TypeScript!' ]
...
console.log("After concatenation: ", str1 + str2); // welcometo typescript
console.log("welcome".concat("home")); //welcomehome
